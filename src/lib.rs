...
impl Compiler {
    pub fn compile(input: &InputTree, options: &CompilerOptions) -> Output {
        let (hir, js, logs) = Compiler::jsify(input);
        let mut code_builder = CodeBuilder::new();
        let mut code = Code::new();
        code.append("/* This source code was automatically generated by karin compiler. */");
        code.append(&format!("g${}$main$main();", input.main_hako_name));
        ...
        Output { file, todos: hir.todos, logs }
    }

    pub fn jsify(input: &InputTree) -> (Hir, Js, HashMap<ModId, Vec<CompilerLog>>) {
